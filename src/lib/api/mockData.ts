...
export const mockHealthTips: HealthTip[] = [
  {
    ...
    content: 'Taking your blood pressure medication at the same time each day helps maintain consistent levels and improves effectiveness.',
    icon: 'Pill',
  },
  {
    id: 'tip-2',
  ...
  },
  {
    ...
    category: 'sleep',
    title: 'Quality Rest',
    content: 'Getting 7-8 hours of sleep helps your body regulate hormones and recover, which is essential for managing chronic conditions.',
    icon: 'Moon',
  },
  {
    id: 'tip-5',
